...
Game Description
Fly Swatter Game is a real-time reaction game built for the Game Boy Advance. 
The player controls a swatter that moves across the screenusing the directional buttons.
...
Win Condition: 5 or more flies swatted 
Lose Condition: Fewer than 5 flies
Restart: Press Select at any time to reset

Technical Features
GMA Mode 3 graphics with pixel-based rendering
